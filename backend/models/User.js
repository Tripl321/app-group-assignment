...
const userSchema = new mongoose.Schema({
  ...
  //         bcrypt med salt rounds 10 är en bra implementation, men lösenord
  //         i sig är sårbara för phishing och brute force.
  //
  ...
  // - Passkeys binder autentisering kryptografiskt till domänen → ingen phishing
  // ============================================================================
  password: {
    type: String,
    required: true,
